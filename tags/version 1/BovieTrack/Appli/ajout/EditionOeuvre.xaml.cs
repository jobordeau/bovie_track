...
namespace Appli
{
    ...
    {
        public ModeEdition Mode { get; private set; } // Permet de connaître l'état actuel de l'application
        ...
        public void Film_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                contentControl.Content = new EditionFilm();
        ...
        private void Serie_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                contentControl.Content = new EditionSerie();
        ...
        private void Livre_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                contentControl.Content = new EditionLivre();
