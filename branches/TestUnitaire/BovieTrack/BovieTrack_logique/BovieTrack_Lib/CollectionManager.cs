...
namespace Modele
{
    ...
    public class CollectionManager
    {
        ...
        private List<string> tagsSelectionnes = new List<string>();
        ...
        private LinkedList<Oeuvre> collectionTriee = new LinkedList<Oeuvre>(); // LinkedList qui permet d'ordonner et de sélectionner les Oeuvres
