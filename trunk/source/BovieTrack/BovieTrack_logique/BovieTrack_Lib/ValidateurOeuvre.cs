...
namespace Modele
{
    ...
    {
        /// <summary>
        /// Vérifie la validité et retourne une liste d'erreurs
        /// </summary>
        /// Les paramètres sont les paramètres du constructeur de Oeuvre
        ...
        /// Vérifie la validité et retourne une liste d'erreurs
        /// </summary>
        /// Les paramètres sont les paramètres du constructeur de Film
        /// <returns> Liste d'erreurs </returns>
        ...
        /// <summary>
        /// Vérifie la validité d'un film déjà créé et retourne une liste d'erreurs
        /// </summary>
        /// <param name="film"> Film à vérifier </param>
        /// <returns> Liste d'erreurs </returns>
        ...
        /// Vérifie la validité et retourne une liste d'erreurs
        /// </summary>
        /// Les paramètres sont les paramètres du constructeur de Livres
        /// <returns>Liste d'erreurs</returns>
        ...
        /// <summary>
        /// Vérifie la validité d'un livre déjà créé et retourne une liste d'erreurs
        /// </summary>
        /// <param name="fivre"> Livre à vérifier </param>
        /// <returns> Liste d'erreurs </returns>
        ...
        /// Vérifie la validité et retourne une liste d'erreurs
        /// </summary>
        /// Les paramètres sont les paramètres du constructeur de Série
        /// <returns>Liste d'erreurs</returns>
        ...
        /// <summary>
        /// Vérifie la validité d'une série déjà créé et retourne une liste d'erreurs
        /// </summary>
        /// <param name="seir"> Série à vérifier</param>
        /// <returns> Liste d'erreurs </returns>
        ...
        /// <summary>
        /// Retourne le message d'erreur adapté à la liste des erreurs
        /// </summary>
        /// <param name="erreurs"> Liste des erreurs à mentionner </param>
