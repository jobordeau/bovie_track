...
namespace DataContractPersistance
{
    ...
    class SerieDTO : OeuvreDTO
    {
        ...
        public SerieDTO(string nom, string image, DateTime? dateFini, DateTime? datePrevue, uint nbFini, uint nbSaisons, EtatSerieDTO etat, List<AvisDTO> listeAvis, ObservableCollection<string> tags)
    ...
    static class SerieExtensions
    {
        ...
        public static Serie ToPOCO(this SerieDTO dto)
            => new Serie(dto.Nom, dto.Image, dto.DateFini, dto.DatePrevue, dto.NbFini, dto.NbSaisons, dto.Etat.ToPOCO(), dto.ListeAvis.ToPOCOs(), dto.Tags);
        public static SerieDTO ToDTO(this Serie poco)
            => new SerieDTO(poco.Nom, poco.Image, poco.DateFini, poco.DatePrevue, poco.NbFini, poco.NbSaisons, poco.Etat.ToDTO(), poco.ListeAvis.ToDTOs(), poco.Tags);
    }
