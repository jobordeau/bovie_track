...
namespace DataContractPersistance
{
    public class DataContractPers : IPersistanceManager
    {
        ...
        public virtual (Dictionary<int, Oeuvre> collection, List<string> tags, int lastID) ChargeDonnees()
        {
        ...
        public virtual void SauvegardeDonnees(Dictionary<int, Oeuvre> collection, List<string> tags, int lastID)
        {
            if (!Directory.Exists(FilePath))
            {
